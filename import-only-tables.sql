-- Sadece Tablo Import Dosyası (Veritabanı oluşturmadan)
-- Mevcut veritabanınıza tabloları import eder
...
SELECT 'Tablolar başarıyla mevcut veritabanına aktarıldı!' as message;
